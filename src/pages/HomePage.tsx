            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4">
                {[
                  ...
                  <div
                    key={feat.title}
                    className="flex gap-4 p-5 bg-surface-container-low hover:bg-surface-container transition-colors duration-200"
                  >
        ...
        <div className="max-w-container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
            ...
            <div className="lg:col-span-4 flex flex-col gap-4">
              ...
              <div className="bg-primary p-8 flex-1 flex flex-col justify-between">
                <div>
        ...
        <div className="max-w-container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center text-center">
            {[
              ...
              <div key={cert.label} className="py-6 border-t-2 border-primary-fixed">
