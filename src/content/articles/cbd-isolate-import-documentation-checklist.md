---
slug: cbd-isolate-import-documentation-checklist
title: "CBD Isolate Import Documentation Checklist for B2B Buyers"
excerpt: "A practical checklist of documents CBD isolate buyers commonly need before bulk import into the EU and other markets, including COA, SDS, HS code, CAS reference, and compliance confirmations."
...
This checklist explains the documents B2B buyers commonly request when evaluating [CBD isolate](/products/cbd-isolate) shipments. It is written for procurement teams, distributors, formulators, and importers who need a clear document trail before moving from inquiry to purchase order.

---

## Why import documentation matters for bulk CBD isolate

CBD isolate (CAS [13956-29-1](https://commonchemistry.cas.org/detail?cas_rn=13956-29-1)) is a controlled or closely reviewed raw material in many markets. In the EU, it may fall under [Novel Food Regulation (EU) 2015/2283](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32015R2283) depending on the intended product category. Even when the product specification looks straightforward, import problems can appear if documentation is inconsistent, incomplete, or not aligned with the buyer's intended application.
...
Documentation does not replace local legal review. Import rules, labeling requirements, product-category rules, and customs expectations vary by country, region, and intended use. Buyers importing into the EU should also review the [European Commission Novel Food Catalogue](https://ec.europa.eu/food/food-feed-portal/screen/novel-food-catalogue/search) for the current status of cannabidiol entries. Consult qualified local advisers and customs partners before shipment.
...
For VETRUX inquiries, buyers can use the [inquiry form](/inquiry) to specify which current documents are required for their order, intended market, and application.

---

## 1. Certificate of Analysis (COA)

The COA is usually the first document quality teams review. It should connect a specific batch or lot to reported analytical results. For higher confidence, buyers may look for COAs issued or verified by laboratories with [ISO/IEC 17025](https://www.iso.org/ISO-IEC-17025-testing-and-calibration-laboratories.html) accreditation, the international standard for testing and calibration laboratory competence.
...
For a deeper review process, see [How to Read a CBD Certificate of Analysis](/blog/how-to-read-cbd-certificate-of-analysis).

---

## 2. Safety Data Sheet (SDS)

The SDS helps warehouse, logistics, and production teams understand safe handling and storage. The standard 16-section SDS format is defined by the [UN Globally Harmonized System (GHS)](https://unece.org/transport/dangerous-goods/ghs-rev11-2024) and adopted by the EU under [REACH Regulation (EC) No 1907/2006, Annex II](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A02006R1907-20231201).
...
For more detail on packaging and handling, see [CBD Isolate Packaging, Storage & Shelf Life](/blog/cbd-isolate-packaging-storage-shelf-life-guide).
...
CBD isolate classification varies by market. The Chinese export HS code used by VETRUX is **2907.29.90.20**, but the receiving country may classify the product differently. Buyers should confirm the correct import HS code with their customs broker before shipment. The [World Customs Organization HS Nomenclature](https://www.wcoomd.org/en/topics/nomenclature/overview.aspx) provides the international framework, but national implementations differ.

### EU-specific considerations

For buyers importing into the European Union:

- CBD isolate may be subject to [Novel Food Regulation (EU) 2015/2283](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32015R2283). Check the [EU Novel Food Catalogue](https://ec.europa.eu/food/food-feed-portal/screen/novel-food-catalogue/search) for the current status of cannabidiol entries.
- THC thresholds and enforcement vary by EU member state. Some countries apply stricter limits than others.
- The SDS should follow the [REACH Regulation Annex II](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A02006R1907-20231201) format.
...
For a detailed overview, see [EU Novel Food Regulation Guide for CBD Importers](/blog/eu-novel-food-regulation-cbd-importers-guide).
...
1. Which documents can be provided for this specific batch and order?
2. Does the COA include the test panels required by our target market?
3. Can the batch number be matched across labels, COA, and packing records?
4. What packaging format will be used for this order?
5. What product description will appear on the invoice and packing list?
6. Which HS code or customs description is proposed, and should our broker review it first?
7. Are any documents available only after production, testing, or packing is complete?
8. Who should our logistics or customs team contact if clarification is needed?
