...
export interface InquiryPageStrings {
  badge: string;
  titleLine1: string;
  titleLine2: string;
  intro: string;
  ...
  oemOdmServices: string;
  oemOdmServicesDesc: string;
  technicalSupport: string;
  technicalSupportDesc: string;
}

export const inquiryPageStrings: Record<Locale, InquiryPageStrings> = {
  en: {
    badge: 'Direct B2B Channels', titleLine1: 'Strategic Partnership', titleLine2: 'Inquiry',
    ...
    cbdRawMaterials: 'CBD Raw Materials', cbdRawMaterialsDesc: 'CBD isolate, 99%+ purity',
    oemOdmServices: 'OEM/ODM Services', oemOdmServicesDesc: 'Formulation to finished product',
    technicalSupport: 'Technical Support', technicalSupportDesc: 'Cultivation & extraction expertise',
  },
  de: {
    badge: 'Direkte B2B-Kanäle', titleLine1: 'Strategische Partnerschaft', titleLine2: 'Anfrage',
    ...
    cbdRawMaterials: 'CBD-Rohstoffe', cbdRawMaterialsDesc: 'CBD-Isolat, Reinheit 99%+',
    oemOdmServices: 'OEM/ODM-Dienstleistungen', oemOdmServicesDesc: 'Von der Formulierung zum Endprodukt',
    technicalSupport: 'Technischer Support', technicalSupportDesc: 'Anbau- und Extraktionsexpertise',
  },
  fr: {
    badge: 'Canaux B2B directs', titleLine1: 'Partenariat stratégique', titleLine2: 'Demande',
    ...
    cbdRawMaterials: 'Matières premières CBD', cbdRawMaterialsDesc: 'Isolat CBD, pureté 99%+',
    oemOdmServices: 'Services OEM/ODM', oemOdmServicesDesc: 'De la formulation au produit fini',
    technicalSupport: 'Support technique', technicalSupportDesc: "Expertise en culture et extraction",
  },
  es: {
    badge: 'Canales B2B directos', titleLine1: 'Asociación Estratégica', titleLine2: 'Consulta',
    ...
    cbdRawMaterials: 'Materias primas CBD', cbdRawMaterialsDesc: 'CBD isolate, pureza 99%+',
    oemOdmServices: 'Servicios OEM/ODM', oemOdmServicesDesc: 'De la formulación al producto terminado',
    technicalSupport: 'Soporte técnico', technicalSupportDesc: 'Experiencia en cultivo y extracción',
  },
  it: {
    badge: 'Canali B2B diretti', titleLine1: 'Partnership Strategica', titleLine2: 'Richiesta',
    ...
    cbdRawMaterials: 'Materie prime CBD', cbdRawMaterialsDesc: 'CBD isolate, purezza 99%+',
    oemOdmServices: 'Servizi OEM/ODM', oemOdmServicesDesc: 'Dalla formulazione al prodotto finito',
    technicalSupport: 'Supporto tecnico', technicalSupportDesc: 'Competenza in coltivazione ed estrazione',
  },
  pt: {
    badge: 'Canais B2B diretos', titleLine1: 'Parceria Estratégica', titleLine2: 'Consulta',
    ...
    cbdRawMaterials: 'Matérias-primas CBD', cbdRawMaterialsDesc: 'CBD isolate, pureza 99%+',
    oemOdmServices: 'Serviços OEM/ODM', oemOdmServicesDesc: 'Da formulação ao produto acabado',
    technicalSupport: 'Suporte técnico', technicalSupportDesc: 'Expertise em cultivo e extração',
  },
  ja: {
    badge: 'B2Bダイレクトチャネル', titleLine1: '戦略的パートナーシップ', titleLine2: 'お問い合わせ',
    ...
    cbdRawMaterials: 'CBD原料', cbdRawMaterialsDesc: 'CBDアイソレート、純度99%+',
    oemOdmServices: 'OEM/ODMサービス', oemOdmServicesDesc: '処方から完成品まで',
    technicalSupport: '技術サポート', technicalSupportDesc: '栽培・抽出の専門知識',
  },
  fi: {
    badge: 'Suorat B2B-kanavat', titleLine1: 'Strateginen kumppanuus', titleLine2: 'Tiedustelu',
    ...
    cbdRawMaterials: 'CBD-raaka-aineet', cbdRawMaterialsDesc: 'CBD-isolaatti, puhtaus 99%+',
    oemOdmServices: 'OEM/ODM-palvelut', oemOdmServicesDesc: 'Formulaatiosta valmiiseen tuotteeseen',
    technicalSupport: 'Tekninen tuki', technicalSupportDesc: 'Viljely- ja uutto-osaaminen',
  },
};
