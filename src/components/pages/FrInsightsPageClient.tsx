...
interface FrInsightsPageClientProps {
  articles: Article[];
}

export default function FrInsightsPageClient({ articles }: FrInsightsPageClientProps) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="reveal-card">
              ...
              <h1 className="text-4xl md:text-5xl font-serif font-medium text-on-background tracking-tight leading-[1.0] mb-6">
                Innovation en
                <br />
                <span className="italic text-primary">Biotechnologie Végétale</span>
              </h1>
              <p className="text-[15px] text-on-surface-variant leading-relaxed mb-8 max-w-md">
                {featured.excerpt}
              </p>
              <div className="flex flex-wrap gap-4 items-center">
                <Link href={`/fr/blog/${featured.slug}`}>
                  <Button variant="accent" size="md" icon={ArrowRight}>Lire le livre blanc</Button>
                </Link>
        ...
        <div ref={gridRef} className="max-w-container mx-auto px-6 lg:px-12">
          <div className="reveal-card">
            ...
            <h2 className="text-3xl font-serif font-medium text-on-background tracking-tight leading-[1.05] mb-12">
              Analyse Industrielle & Recherche
            </h2>
          </div>
