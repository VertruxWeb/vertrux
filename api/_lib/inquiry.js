...
export function validateInquiryPayload(payload, options = {}) {
...
function buildMail(payload, referenceId, config, ip) {
...
export async function handleInquirySubmission(args) {
